...
{
f: expand-axiom "[7]++[7]++[7]++[7]++[7]" 3 [
     "6" [ " (blue) 81++91----71[-81----61]++" ] 
     "7" [ "+81--91[---61--71]+" ] 
     "8" [ "-61++71[+++81++91]-" ] 
     "9" [ "--81++++61[+91++++71]--71" ] 
     "1" [ "" ] 
]
p: parse-expanded f "1" 36 0
n: normalize-coords p 110


f: expand-axiom "[7]++[7]++[7]++[7]++[7]" 5 [
     "6" [ "(red)81++91----71[-81----61]++" ] 
     "7" [ "+81--91[---61--71]+" ] 
     "8" [ "-61++71[+++81++91]-" ] 
     "9" [ "--81++++61[+91++++71]--71" ] 
     "1" [ "" ] 
...
load-sample: func [ n ] [
    if samples-enabled [
        ...
        angle-field/text: copy smpl/1 
        rotate-field/text: copy smpl/2 
        iter-field/text: form 1 + do copy smpl/3
        axiom-field/text: copy smpl/4
        use-field/text: copy smpl/5
